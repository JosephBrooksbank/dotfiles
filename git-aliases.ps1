...
git config --global alias.rr '!git fetch origin && git reset --hard @{u}'
...
git config --global alias.psypot '!git push origin $(git branch --show-current):psychic-potato --force'
